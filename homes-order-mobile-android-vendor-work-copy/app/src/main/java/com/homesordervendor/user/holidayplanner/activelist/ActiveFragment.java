package com.homesordervendor.user.holidayplanner.activelist;
...
import com.homesordervendor.databinding.FragmentActiveBinding;
import com.homesordervendor.user.holidayplanner.activelist.adapter.ActiveAdapter;
import com.homesordervendor.user.holidayplanner.activelist.viewmodel.ActiveVM;
...
public class ActiveFragment extends Fragment {
    ...
    private void bindView(LayoutInflater inflater, ViewGroup container){
        ...
        activeVM=new ActiveVM(getActivity());
        binding.setActiveVM(activeVM);
    }
    ...
    private void getIntentData(){
        ...
        if (bundle!=null){
            list= (List<HolidayPlanner>) bundle.getSerializable("active");
        }
    }
