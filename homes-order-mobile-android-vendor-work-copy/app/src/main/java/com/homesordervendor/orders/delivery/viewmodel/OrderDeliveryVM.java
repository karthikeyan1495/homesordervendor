package com.homesordervendor.orders.delivery.viewmodel;
...
public class OrderDeliveryVM extends java.util.Observable{
    ...
    public OrderDeliveryVM(Activity activity){
    ...
    public void orderListAPICall(){
        if (InternetChecker.getInstance().isReachable()) {
            ...
            Observable<Response<List<OrderItem>>> observable = api.orderList(MySession
                    .getInstance(activity).getUser().getToken(), OrderStatus.DELIVERY.getValue());
