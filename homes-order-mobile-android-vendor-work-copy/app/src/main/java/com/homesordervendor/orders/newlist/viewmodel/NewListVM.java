...
public class NewListVM extends java.util.Observable{
    ...
    public NewListVM(Activity activity){
    ...
    public void orderListAPICall(){
        if (InternetChecker.getInstance().isReachable()) {
            ...
            Observable<Response<List<OrderItem>>> observable = api.orderList(MySession.getInstance(activity).getUser().getToken(), OrderStatus.NEW.getValue());
