package com.homesordervendor.orders.cancelled.viewmodel;
...
public class OrderCancelledVM extends java.util.Observable{
    ...
    public OrderCancelledVM(Activity activity){
    ...
    public void orderListAPICall(){
        if (InternetChecker.getInstance().isReachable()) {
            ...
            Observable<Response<List<OrderItem>>> observable = api.orderList(MySession
                    .getInstance(activity).getUser().getToken(), OrderStatus.CANCELED.getValue());
