...
public class FeaturedListVM extends java.util.Observable{
    ...
    public FeaturedListVM(Activity activity){
    ...
    public void featuredListAPICall(){
        if (InternetChecker.getInstance().isReachable()) {
            ...
            Observable<Response<ProductListResponse>> observable = api.productFeatureList(MySession.getInstance(activity).getUser().getToken());
