...
import com.homesordervendor.databinding.ActivityTelrPaymentFailedBinding;
...
import com.homesordervendor.product.featured.payment.viewmodel.TelrPaymentFailedVM;
...
public class TelrPaymentFailedActivity extends AppCompatActivity {

    ActivityTelrPaymentFailedBinding binding;
    TelrPaymentFailedVM telrPaymentFailedVM;
    ...
    private void bindView(){
        binding= DataBindingUtil.setContentView(this, R.layout.activity_telr_payment_failed);
        telrPaymentFailedVM=new TelrPaymentFailedVM(this);
        binding.setTelrPaymentFailedVM(telrPaymentFailedVM);
