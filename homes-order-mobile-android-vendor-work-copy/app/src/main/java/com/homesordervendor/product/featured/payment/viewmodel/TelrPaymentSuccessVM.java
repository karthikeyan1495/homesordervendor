...
import com.homesordervendor.databinding.ActivityTelrPaymentSuccessBinding;
...
public class TelrPaymentSuccessVM {
    ...
    public TelrPaymentSuccessVM(@NonNull Activity activity, ActivityTelrPaymentSuccessBinding binding, String transactionId){
        ...
        setFeatureDateAPICall(MySession.getInstance(activity).getFeaturedRequest());
    }
    ...
    private void setFeatureDateAPICall(FeaturedRequest featuredRequest){
        featuredRequest.setRefId(transactionId);
                    ...
                    .subscribe(responses -> {
                        ...
                        if (responses.code() == 200) {
                            ...
                            if (responses.body() != null) {
                                ...
                                APIErrorHandler.getInstance().errorHandler(activity, responses
                                        .code(), responses.errorBody().string());
                            }
                        }
                    }, throwable -> {
                        myProgressDialog.dismissDialog();
